[Nodes Manual](https://comfyui-wiki.com/en/comfyui-nodes "Nodes Manual")AdvancedconditioningCLIP Text Encode SDXL
### [Alibaba Cloud PAI Releases Z-Image-Turbo-Fun-Controlnet-Union - Multi-Condition ControlNet Model](https://comfyui-wiki.com/en/news/2025-12-02-z-image-turbo-controlnet-union)
12/01/2025
# CLIP Text Encode SDXL
![comfyUI Node-CLIPTextEncodeSDXLRefiner|CLIP文本编码SDXL（Refiner）](https://comfyui-wiki.com/advanced/conditioning/CLIPTextEncodeSDXL.jpg)
## Documentation[](https://comfyui-wiki.com/en/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl#documentation)
...
## CLIPTextEncodeSDXL Input types[](https://comfyui-wiki.com/en/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl#cliptextencodesdxl-input-types)
...
## CLIPTextEncodeSDXL Output types[](https://comfyui-wiki.com/en/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl#cliptextencodesdxl-output-types)
Parameter | Comfy dtype | Description  
---|---|---  
...
[](https://comfyui-wiki.com/en/comfyui-nodes "Nodes Manual")[CLIP Text Encode SDXL Refiner](https://comfyui-wiki.com/en/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl-refiner "CLIP Text Encode SDXL Refiner")
Discover more
ComfyUI
SDXL
Text-to-image model
